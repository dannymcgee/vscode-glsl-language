 ...
 * @param offset Specifies the offsets, in texels at which the texture will be sampled relative to the projection of . 
 */
 ...
 * @param offset Specifies the offsets, in texels at which the texture will be sampled relative to the projection of . 
 */
float textureProjGradOffset( isampler2DRectShadow sampler, vec4 P, vec2 dPdx, vec2 dPdy, ivec2 offset )
 ...
 * @param offset Specifies the offsets, in texels at which the texture will be sampled relative to the projection of . 
 */
float textureProjGradOffset( usampler2DRectShadow sampler, vec4 P, vec2 dPdx, vec2 dPdy, ivec2 offset )
